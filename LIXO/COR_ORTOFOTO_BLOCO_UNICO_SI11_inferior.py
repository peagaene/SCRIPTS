...
formato = '.tif'
dir_fotos = r'D:\_teste\11'
dir_output = r'D:\_teste\11\Nova pasta'
...
for i in tqdm(range(len(lista_dir)), desc="Processando imagens", unit="imagem"):
    ...
    process_image(
        ...
        brightness_adjustment=-40,  # Ajuste de brilho
        contrast=1.0,            # Ajuste de contraste
        intensity_factor=1.10,    # Ajuste de intensidade
        red=-15, green=-20, blue=-20, # Ajuste individual dos canais RGB
        saturation_factor=1.2,   # Aumentar saturação
