...
formato = '.tif'
dir_fotos = r'\\192.168.2.29\d\SI_08\DIVISAS_RGB_SI03_SI08\IR'
dir_output = r'\\192.168.2.29\d\SI_08\DIVISAS_RGB_SI03_SI08\IR\Nova pasta'
...
for i in tqdm(range(len(lista_dir)), desc="Processando imagens", unit="imagem"):
    ...
    process_image(
        ...
        gamma=0.85,               # Ajuste de gama
        brightness_adjustment=5,  # Ajuste de brilho
        contrast=1.1,            # Ajuste de contraste
        intensity_factor=1,    # Ajuste de intensidade
        red=-27, green=-30, blue=-35, # Ajuste individual dos canais RGB
        saturation_factor=1.5,   # Aumentar saturação
