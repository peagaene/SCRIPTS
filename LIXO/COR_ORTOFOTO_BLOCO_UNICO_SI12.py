...
formato = '.tif'
dir_fotos = r'D:\_teste\12'
dir_output = r'D:\_teste\12\Nova pasta'
...
for i in tqdm(range(len(lista_dir)), desc="Processando imagens", unit="imagem"):
    ...
    process_image(
        ...
        brightness_adjustment=-30,  # Ajuste de brilho
        contrast=1.0,            # Ajuste de contraste
        intensity_factor=1.10,    # Ajuste de intensidade
        red=-15, green=-30, blue=-30, # Ajuste individual dos canais RGB
