...
def process_image(source_path, output_path, gamma, brightness_adjustment, x, y, z):
    ...
    final_image = subtract_values(brightness_adjusted_image.copy(), x=x, y=y, z=z)
...
formato = '.tif'
dir_fotos = r'D:\SI_04\SI_08\OUT'
dir_output = r'D:\SI_04\SI_08\RGB'
...
for i in tqdm(range(len(lista_dir)), desc="Processando imagens", unit="imagem"):
    ...
    process_image(lista_dir[i], output_file, gamma=1.3, brightness_adjustment=-40, x=8, y=8, z=0)
