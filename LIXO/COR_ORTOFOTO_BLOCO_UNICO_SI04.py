...
formato = '.tif'
dir_fotos = r'\\192.168.2.29\d\SI_04\SI_09\SI04_IR'
dir_output = r'\\192.168.2.29\d\SI_04\SI_09\SI04_COR'
...
for i in tqdm(range(len(lista_dir)), desc="Processando imagens", unit="imagem"):
    ...
    process_image(
        ...
        gamma=0.8,               # Ajuste de gama
        brightness_adjustment=15,  # Ajuste de brilho
        contrast=1,            # Ajuste de contraste
        intensity_factor=1,    # Ajuste de intensidade
        red=-20, green=-40, blue=-40, # Ajuste individual dos canais RGB
        saturation_factor=1.4,   # Aumentar saturação
