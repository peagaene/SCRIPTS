...
formato = '.tif'
dir_fotos = r'\\192.168.2.29\d\SI_06\SI_02\SI02_IR'
dir_output = r'\\192.168.2.29\d\SI_06\SI_02\SI02_COR'
...
for i in tqdm(range(len(lista_dir)), desc="Processando imagens", unit="imagem"):
    ...
    process_image(
        ...
        red=-24, green=-40, blue=-40, # Ajuste individual dos canais RGB
