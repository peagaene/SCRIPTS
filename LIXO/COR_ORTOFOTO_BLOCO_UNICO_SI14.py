...
formato = '.tif'
dir_fotos = r'K:\SP22_BE_13_03052024_HD03\SI_14\IR'
dir_output = r'F:\SI_14\IR'
...
for i in tqdm(range(len(lista_dir)), desc="Processando imagens", unit="imagem"):
    ...
    process_image(
        ...
        gamma=1.2,               # Ajuste de gama
        brightness_adjustment=-50,  # Ajuste de brilho
        contrast=1.2,            # Ajuste de contraste
        intensity_factor=1.10,    # Ajuste de intensidade
        red=-20, green=-25, blue=-25, # Ajuste individual dos canais RGB
        saturation_factor=1.1,   # Aumentar saturação
