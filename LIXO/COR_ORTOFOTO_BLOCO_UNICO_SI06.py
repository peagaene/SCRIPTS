...
formato = '.tif'
dir_fotos = r'D:\_TESTE\COR_IR\IR\6'
dir_output = r'D:\_TESTE\COR_IR\IR\Nova pasta'
...
for i in tqdm(range(len(lista_dir)), desc="Processando imagens", unit="imagem"):
    ...
    process_image(
        ...
        gamma=0.95,               # Ajuste de gama
        brightness_adjustment=-40,  # Ajuste de brilho
        contrast=1.1,            # Ajuste de contraste
        intensity_factor=1.15,    # Ajuste de intensidade
        red=0, green=0, blue=-10, # Ajuste individual dos canais RGB
