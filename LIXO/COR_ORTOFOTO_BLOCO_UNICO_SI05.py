...
formato = '.tif'
dir_fotos = r'\\192.168.2.29\d\SI_09\SI_05\SI05_IR'
dir_output = r'\\192.168.2.29\d\SI_09\SI_05\SI05_COR'
...
for i in tqdm(range(len(lista_dir)), desc="Processando imagens", unit="imagem"):
    ...
    process_image(
        ...
        red=-15, green=-40, blue=-40, # Ajuste individual dos canais RGB
