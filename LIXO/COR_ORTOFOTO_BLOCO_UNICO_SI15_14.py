...
formato = '.tif'
dir_fotos = r'K:\SP22_BE_13_03052024_HD03\SI_15\IR\AZUL\MUITO'
dir_output = r'K:\SP22_BE_13_03052024_HD03\SI_15\IR\AZUL\IR_MUITO'
...
for i in tqdm(range(len(lista_dir)), desc="Processando imagens", unit="imagem"):
    ...
    process_image(
        ...
        gamma=1.0,               # Ajuste de gama
        brightness_adjustment=0,  # Ajuste de brilho
        contrast=1.1,            # Ajuste de contraste
        intensity_factor=1.00,    # Ajuste de intensidade
        red=40, green=-20, blue=-20, # Ajuste individual dos canais RGB
        saturation_factor=1.0,  # Aumentar saturação
